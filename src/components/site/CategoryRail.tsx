...
export function CategoryRail({
  ...
  return (
    <section className="relative -mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0" aria-label="Filter hidden spaces by category">
        ...
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`group min-h-11 rounded-full border px-4 py-2 text-sm font-bold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1E4E8C] active:scale-[0.98] ${
                isActive
